...
DevKits.Generated.animationSpeed     = 200;
DevKits.Generated.maximumURLLength   = 100;
DevKits.Generated.syntaxHighlighters = [];

// Adds a document
DevKits.Generated.addDocument = function(documentURL, documentCount, itemDescription, itemCount)
{
    ...
    childElement.appendChild(document.createTextNode(DevKits.Generated.formatURL(documentURL)));
...
// Adds a separator
DevKits.Generated.addSeparator = function()
{
...
DevKits.Generated.changeSyntaxHighlightTheme = function(event)
{
    var themeMenu = $(this);
    ...
    if(themeIcon.hasClass("icon-empty"))
    {
        ...
        else if(DevKits.Generated.syntaxHighlighters.length)
        {
            $(".CodeMirror").show();
            $(".web-developer-syntax-highlight").hide();

            // Loop through the syntax highlighters
            for(var i = 0, l = DevKits.Generated.syntaxHighlighters.length; i < l; i++)
            {
                DevKits.Generated.syntaxHighlighters[i].setOption("theme", theme);
            }
        }
        else
        {
            DevKits.Generated.initializeSyntaxHighlight(theme);
        }
...
DevKits.Generated.collapseAllOutput = function(event)
{
    ...
    $("h3").each(function()
    {
        ...
        header.next(":not(.web-developer-separator)").slideUp(DevKits.Generated.animationSpeed);
    });
...
// Empties the content
DevKits.Generated.emptyContent = function()
{
    $(".progress", $("#content")).remove();
};

// Expands all the output
DevKits.Generated.expandAllOutput = function(event)
{
    // Loop through the output headers
    $("h3").each(function()
    {
        ...
        header.next(":not(.web-developer-separator)").slideDown(DevKits.Generated.animationSpeed);
    });
...
// Formats a URL
DevKits.Generated.formatURL = function(url)
{
    // If the URL is set
    if(url && url.length > DevKits.Generated.maximumURLLength)
    {
        var halfLength = DevKits.Generated.maximumURLLength / 2;
...
DevKits.Generated.generateDocumentContainer = function()
{
...
DevKits.Generated.initializeCommonElements = function()
{
    $("i", $("h3")).on("click", DevKits.Generated.toggleOutput);
    $("#web-developer-collapse-all").on("click", DevKits.Generated.collapseAllOutput);
    $("#web-developer-expand-all").on("click", DevKits.Generated.expandAllOutput);
...
DevKits.Generated.initializeSyntaxHighlight = function(color, locale)
{
    ...
    if(locale)
    {
        ...
        $(".dropdown-menu a", $("#web-developer-syntax-highlighting-dropdown")).on("click", DevKits.Generated.changeSyntaxHighlightTheme);
    ...
    if(color != "none")
    {
        ...
        $(".web-developer-syntax-highlight").each(function()
        {
            ...
            window.setTimeout(function()
            {
                ...
                DevKits.Generated.syntaxHighlighters.push(CodeMirror(function(element)
                    {
                        pre.after(element);
                        pre.hide();
                    },
...
DevKits.Generated.initializeWithJSON = function(event)
{
    var eventTarget = event.target;

    DevKits.Generated.initialize(JSON.parse(eventTarget.getAttribute("data-web-developer")), JSON.parse(eventTarget.getAttribute("data-web-developer-locale")));

    eventTarget.removeAttribute("data-web-developer");
    eventTarget.removeAttribute("data-web-developer-locale");

    window.removeEventListener("web-developer-generated-event", DevKits.Generated.initializeWithJSON, false);
};

// Localizes the header
DevKits.Generated.localizeHeader = function(locale)
{
    if(locale){
        ...
        $("#web-developer-collapse-all").text("折叠所有");
        $("#web-developer-expand-all").text("展开所有");
        // $(".dropdown-toggle", $("#documents-dropdown")).prepend(locale.documents);
        // $(".navbar-text").text(locale.extensionName);
    }
...
// Outputs content
DevKits.Generated.output = function(title, url, anchor, type, outputOriginal)
{
    var childElement      = document.createElement("i");
    var container         = document.createElement("pre");
    var content           = document.getElementById("content");
    var documentContainer = DevKits.Generated.generateDocumentContainer();
    ...
    {
        childElement = document.createElement("a");
        outputTitle  = DevKits.Generated.formatURL(url);
...
// Sets the page title
DevKits.Generated.setPageTitle = function(type, data, locale)
{
    document.title = type + " " + locale.from.toLowerCase() + " " + DevKits.Generated.formatURL(data.pageURL);

    $(".navbar-brand").text(type);
};

// Toggles the collapsed state of an output
DevKits.Generated.toggleOutput = function()
{
    $(this).toggleClass("icon-collapse-alt").toggleClass("icon-expand-alt").parent().next().slideToggle(DevKits.Generated.animationSpeed);
};

window.addEventListener("web-developer-generated-event", DevKits.Generated.initializeWithJSON, false);
