/**
 * 本库提供几个常用方法：
 * 1、endecode.uniEncode(text);    将中文进行Unicode编码并输出
 * 2、endecode.base64Encode(text); 将文字进行base64编码并输出
 * 3、endecode.base64Decode(text); 将经过base64编码的文字进行base64解码并输出
 * 4、endecode.utf8Encode(text); 将文字进行utf-8编码并输出
 * 5、endecode.utf8Decode(text); 将经过utf-8编码的文字进行utf-8解码并输出
 */
endecode = (function () {
    //base64编码字符集
